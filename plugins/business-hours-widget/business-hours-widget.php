 ...
 * @author    Ringo Ng <ringong95@gmail.com>
 * @license   GPL-2.0+
 * @link      https://github.com/ringong95/
 * @copyright 2016 Ringo Ng
 *
 * @wordpress-plugin
 * Plugin Name:       Business Hours Widget
 * Plugin URI:        http://google.com
 * Description:       A custom bussiness hour widet plugin.
 * Version:           1.0.0
 * Author:            Ringo Ng
 * Author URI:        https://github.com/ringong95/
 * License:           GPL-2.0+
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Add the bussines\' weekly hours.'
				)
			);
